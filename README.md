...
4. **回到Emby页面，刷新一下再回到 _开发者工具_ 页面**
5. **点 _index.html_ 文件，点右侧的 _启动器_ 选项卡**
...
7. **返回 _ProxyPin_，在顶栏输入 _api_key_，点击任意项**
...
4. **在控制台左侧菜单往下滑动，点 _高级_，在顶栏点 _安全_**
5. **点 _API密钥_ 旁的 _添加_，为API密钥输入一个名称以便于识别**
6. **复制创建的API密钥**
7. **启动 _Animeko_，进 _数据源管理_，点 _+_ 选择 _Emby_**
8. **在弹出窗口依次填入 _服务器地址、User Id、API Key_ 点 _保存_**
