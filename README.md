...
6. **从启动器下的链接找到 _api_key=_ 和 _UserId=_ 后面的参数，到 _&_ 为止**
7. **打开Animeko，进 _数据源管理_，点 _+_ 选择 _Emby_**
8. **在弹出窗口依次填入 _服务器地址、User Id、API Key_ 点 _保存_**

### **实战: 私人Emby数据源编写（Jellyfin同理）**
1. **用管理员账号登录Emby服务器**
2. **打开服务器控制面板**
3. **在主仪表板页面，向下滚动到左侧菜单面板的底部**
4. **在 _专家_ 下，点击 _高级_**
5. **在顶部栏点击 _安全_**
6. **点击 _添加_，并在弹出对话框中，为API密钥输入一个名称以便于识别**
7. **打开Animeko，进 _数据源管理_，点 _+_ 选择 _Emby_**
8. **在弹出窗口依次填入 _服务器地址、User Id、API Key_ 点 _保存_**
